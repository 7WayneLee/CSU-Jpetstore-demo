	...
	<form action="conFirmOrderForm" method="post">
	    <table>
			...
			<tr>
				...
				<td>
					<select>
						<option value="Bank Card" selected="selected">Bank Card</option>
						<option value="Chinese IDCard">Chinese IDCard</option>
						<option value="Chinese Passport">Chinese Passport</option>
					</select>
				</td>
			</tr>
			<tr>
				<td>Card Number:</td>
				<td>
					<input type="text" name="creditCard" value="123456789">
				</td>
			</tr>
			<tr>
				<td>Current Date (MM/YY/YY):</td>
				<td>
					<input type="text" name="expiryDate" value="2022/01/11"/>
				</td>
			</tr>
